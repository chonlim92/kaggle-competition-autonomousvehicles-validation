...
AV Validation Agent ÔÇö Main Runtime & Gradio Dashboard
=======================================================
...
---------------------
                        ...
                        Ôöé              Gradio Dashboard (this file)         Ôöé
                        Ôöé                                                    Ôöé
                        Ôöé  Tab 1: Synthetic Data Generation Engine          Ôöé
                        Ôöé    ÔööÔöÇÔû║ AVDisengagementLogSimulator                Ôöé
                        Ôöé          (gemini-2.0-flash, data_simulator.py)    Ôöé
                        Ôöé                                                    Ôöé
                        Ôöé  Tab 2: Secure Validation Audit Portal            Ôöé
                        Ôöé    Ôö£ÔöÇÔû║ EnterpriseAVSecurityPIICleaner  (regex)    Ôöé
                        Ôöé    Ôöé     [DRIVER_REDACTED][PLATE_REDACTED][GPS]   Ôöé
                        Ôöé    ÔööÔöÇÔû║ av_compliance_agent             (ADK)      Ôöé
                        Ôöé          (gemini-1.5-pro, structured report)      Ôöé
                        Ôöé                                                    Ôöé
                        Ôöé  Tab 3: Automated Performance Evaluation          Ôöé
                        Ôöé    Ôö£ÔöÇÔû║ PII redaction recall tests (JSONL dataset) Ôöé
                        Ôöé    ÔööÔöÇÔû║ Guardrail rule validation tests            Ôöé
...
Data Flow ÔÇö Tab 2 (critical path):
  raw_log_text (user input)
      Ôöé
      Ôû╝
  enterprise_av_security_pii_cleaner.clean_pii()    [deterministic regex pass]
      Ôöé  Returns: redacted_text, redaction_summary
      Ôû╝
  purified_context  ÔùäÔöÇÔöÇ displayed in "Purified Outbound Prompt Context" box
      Ôöé
      Ôû╝
  compliance_system_prompt + purified_context
      Ôöé  ÔåÆ sent to ADK Runner (av_compliance_agent, gemini-1.5-pro)
      Ôû╝
  structured compliance report  ÔùäÔöÇÔöÇ displayed as markdown

Key design decisions:
  - gemini-2.0-flash used for simulator (Tab 1) ÔÇö high-throughput, low cost
  - gemini-1.5-pro used for compliance agent (Tab 2) ÔÇö higher reasoning quality
...
# ÔöÇÔöÇ Project root path resolution ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
# ÔöÇÔöÇ Globals & State ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
# ÔöÇÔöÇ Structured logging ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
# Using structlog for machine-parseable output ÔÇö critical for production audit trails.
...
# ==============================================================================
# Backend Imports ÔÇö guarded to give informative errors on missing dependencies
# ==============================================================================
...
try:
    ...
    logger.warning("google-adk not available ÔÇö Tab 2 compliance agent disabled", error=str(_e))

# Internal skill modules ÔÇö always available (pure Python, no external deps beyond regex)
...
# Simulator ÔÇö requires google-generativeai (Tab 1 only)
...
# Agent config ÔÇö used to pull API key and model selection from .env
...
# It is paired with the PURIFIED (PII-free) log context ÔÇö never raw user input.
...
1. Your input is a PURIFIED log excerpt. All PII has already been redacted by the enterprise
   ...
   [GPS_REDACTED]) as the authoritative representation of those fields ÔÇö never speculate
...
[CRITICAL / HIGH / MEDIUM / LOW] ÔÇö [one-sentence summary]
...
---
*Report generated by AV Validation Orchestrator ÔÇö gemini-1.5-pro | Classification: INTERNAL*
"""
...
# ÔöÇÔöÇ Gemini API configuration ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
# ÔöÇÔöÇ Data Simulator (Tab 1) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
# AVDisengagementLogSimulator uses gemini-2.0-flash.
# High temperature (0.95) is used to produce diverse, realistic log text.
# This simulator is intentionally separate from the compliance model ÔÇö the
...
# ÔöÇÔöÇ ADK Compliance Agent (Tab 2) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
# the agent ÔÇö no user-specific state is persisted between sessions).
...
if _ADK_AVAILABLE:
    try:
        _compliance_agent = LlmAgent(
            ...
            # No tools registered on this agent ÔÇö it is a pure reasoning/generation agent.
            tools=[],
        )
...
# ==============================================================================
# Helper: ADK Runner ÔåÆ response string
# ==============================================================================
...
async def _run_adk_agent(message: str, session_id: str) -> str:
    ...
    # InMemorySessionService is ephemeral ÔÇö sessions are lost on server restart.
    ...
    # Tool call events (role="tool") are skipped here ÔÇö this agent has no tools.
    async for event in _adk_runner.run_async(
        ...
        # Check for content attribute defensively ÔÇö some events carry metadata only.
...
# ==============================================================================
# TAB 1 BACKEND ÔÇö Synthetic Data Generation Engine
# ==============================================================================
...
def generate_synthetic_log() -> tuple[str, str, str]:
    ...
    try:
        ...
        final_log_text = "\n".join(all_logs_text)
        final_meta_text = (
            f"Ô£à Batch generated in {elapsed:.2f}s  |  Model: {results[0]['model']}\n"
            f"{'ÔöÇ'*60}\n"
        ...
        return f"ÔØî Generation failed: {exc}", "", ""


# ==============================================================================
# TAB 2 BACKEND ÔÇö Secure Validation Audit Portal
# ==============================================================================
...
def run_secure_validation(raw_log_text: str, session_id: str) -> tuple[str, str, str, str]:
    """
    Tab 2 action handler: PII cleaning ÔåÆ ADK compliance agent ÔåÆ report.
    Returns:
    ...
    if not raw_log_text or not raw_log_text.strip():
        return (
            "ÔÜá´©Å No input provided. Paste a log into the text field first.",
            "",
            "",
            "",
        )

    # ÔöÇÔöÇ Stage 1: Deterministic PII Cleaning ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    logger.info("Tab 2: Stage 1 ÔÇö running enterprise PII cleaner")
    t0 = time.perf_counter()
    ...
    if pii_found:
        status_icon = ""
        status_msg = f"SECURED ÔÇö {summary['total']} PII entity/entities redacted"
    else:
        status_icon = "Ô£à"
        status_msg = "CLEAN ÔÇö No PII patterns detected in input"
    ...
    redaction_banner = (
        ...
        f"{detail_block}\n"
        f"{'ÔöÇ'*60}\n"
        f"ÔÜá´©Å  SECURITY BOUNDARY: The purified context below is the ONLY text\n"
    ...
    # ÔöÇÔöÇ Stage 2: ADK Compliance Report Generation ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    logger.info("Tab 2: Stage 2 ÔÇö dispatching to ADK compliance agent", model=COMPLIANCE_MODEL)

    if not _ADK_AVAILABLE or _adk_runner is None:
        compliance_report = (
            "## ÔÜá´©Å ADK Compliance Agent Unavailable\n\n"
    ...
    compliance_report = (
        f"{adk_response}\n\n"
        f"---\n"
        f"*Audit metadata ÔÇö PII entities redacted: {summary['total']} "
...
# ==============================================================================
# TAB 3 BACKEND ÔÇö Automated Performance Evaluation Suite
# ==============================================================================
...
def execute_evaluation_suite() -> str:
    ...
    What this suite tests:
      1. PII Redaction Recall ÔÇö loaded from tests/evaluation/datasets/pii_redaction.jsonl
      ...
      2. Enterprise Cleaner Smoke Tests ÔÇö four synthetic AV log strings covering
      ...
      3. Guardrail Rule Boundary Tests ÔÇö tests against GR-TOK-003 (padding phrases)
         and GR-TONE-001 (hyperbole phrases) pattern lists defined in guardrails.txt.
         These are lightweight string-match checks ÔÇö they verify the cleaner does NOT
    ...
    results.append("=" * 70)
    results.append("  AV VALIDATION AGENT ÔÇö PERFORMANCE EVALUATION SUITE")
    results.append(f"  {time.strftime('%Y-%m-%dT%H:%M:%SZ', time.gmtime())}")
    results.append("=" * 70)

    # ÔöÇÔöÇ Test Suite 1: PII Redaction Recall (JSONL dataset) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    results.append("\n SUITE 1 ÔÇö PII REDACTION RECALL (JSONL EVAL DATASET)")
    results.append("ÔöÇ" * 70)

    pii_jsonl_path = _EVAL_DATASET_DIR / "pii_redaction.jsonl"
    if not pii_jsonl_path.exists():
        results.append(f"  ÔÜá´©Å  Dataset not found: {pii_jsonl_path}")
        ...
        for case in cases:
            ...
            if missed:
                for m in missed:
                    results.append(f"       ÔÜá´©Å  MISSED: '{m[:50]}'")

        results.append(
            f"\n  Suite 1 Result: {suite1_passed}/{len(cases)} PASSED  "
            f"({'PASS Ô£à' if suite1_passed == len(cases) else 'FAIL ÔØî'})"
        )

    # ÔöÇÔöÇ Test Suite 2: Enterprise Cleaner Smoke Tests ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    results.append("\n SUITE 2 ÔÇö ENTERPRISE CLEANER SMOKE TESTS")
    results.append("ÔöÇ" * 70)
    ...
    SMOKE_TESTS: list[dict[str, Any]] = [
        ...
        {
            "id": "smoke-gps-bare",
            "description": "Bare decimal GPS pair (ÔëÑ4 decimal places)",
        ...
        },
        {
            ...
            "description": "Clean technical text (no PII ÔÇö must pass through unchanged)",
            "input": (
    ...
    results.append(
        ...
        f"({'PASS Ô£à' if suite2_passed == len(SMOKE_TESTS) else 'FAIL ÔØî'})"
    )

    # ÔöÇÔöÇ Test Suite 3: Guardrail Boundary Verification ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    results.append("\n´©Å  SUITE 3 ÔÇö GUARDRAIL RULE BOUNDARY VERIFICATION (GR-TOK / GR-TONE)")
    results.append("ÔöÇ" * 70)
    ...
    BOUNDARY_TESTS: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "description": "Low-precision coords (2dp) preserved ÔÇö not GPS precision",
            "input": "Steering angle deviation: 37.77 degrees. Yaw rate: 0.03 rad/s.",
            "preserve": ["37.77"],  # Only 2dp ÔÇö should NOT be treated as GPS
        },
    ]
    ...
    results.append(
        ...
        f"({'PASS Ô£à' if suite3_passed == len(BOUNDARY_TESTS) else 'FAIL ÔØî'})"
    )

    # ÔöÇÔöÇ Overall Suite Summary ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    overall_pass = total_passed == total_tests
    results.append("\n" + "=" * 70)
    results.append(
        f"  OVERALL RESULT: {total_passed}/{total_tests} tests passed  "
        f"{'Ô£à ALL PASSING' if overall_pass else 'ÔØî FAILURES DETECTED'}"
    )
    results.append(
        f"  Suite 1 (JSONL Recall) : {'ÔöÇ' * 2} see above\n"
...
_CUSTOM_CSS = """
/* ÔöÇÔöÇ Global ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
/* ÔöÇÔöÇ Glassmorphism Mixin ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
.glass-panel {
...
/* ÔöÇÔöÇ Header ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
.app-header {
...
/* ÔöÇÔöÇ Tabs ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
.tab-nav button {
...
/* ÔöÇÔöÇ Buttons ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
/* ÔöÇÔöÇ Textboxes / inputs ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
/* ÔöÇÔöÇ Markdown panels ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
.prose, .markdown-text {
    background: rgba(24, 24, 27, 0.4) !important;
    backdrop-filter: blur(12px) !important;
    -webkit-backdrop-filter: blur(12px) !important;
...
/* ÔöÇÔöÇ Status indicator ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
...
# ÔöÇÔöÇ Session state initialiser ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
# ÔöÇÔöÇ Build the Gradio Blocks interface ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
with gr.Blocks(  # pragma: no cover
    ...
    css=_CUSTOM_CSS,
    title="AV Validation Agent ÔÇö Enterprise Dashboard",
) as demo:

    # ÔöÇÔöÇ Session state (per-user, not persisted) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    # ÔöÇÔöÇ Application header ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    gr.HTML("""
    <div class="app-header">
        <h1> AV Validation Agent ÔÇö Enterprise Dashboard</h1>
        <p>
            ADK 2.0 multi-agent pipeline &nbsp;|&nbsp;
            gemini-1.5-pro (compliance) &nbsp;ÔÇó&nbsp; gemini-2.0-flash (simulator) &nbsp;|&nbsp;
    ...
    # TAB 1 ÔÇö Synthetic Data Generation Engine
    # ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
    with gr.Tab("ÔÜí 1. Synthetic Data Generation Engine"):
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                # This is deliberately labelled "RAW ÔÇö contains PII" to signal
                # to developers that this text should NOT go directly to a model.
                tab1_log_output = gr.Textbox(
                    label=" Generated Raw Log  [ RAW ÔÇö CONTAINS PII ÔÇö DO NOT FORWARD TO LLM ]",
                    lines=22,
                    max_lines=40,
                    placeholder=(
                        "Generated AV disengagement log will appear here...\n\n"
                        "Copy this text to Tab 2 ÔåÆ 'Paste Log Text' to run the "
        ...
        # Generate button ÔÇö triggers generate_synthetic_log() backend handler
        with gr.Row():
            tab1_generate_btn = gr.Button(
                "ÔÜí Generate Synthetic AV Log Data",
                variant="primary",
                size="lg",
        ...
        # Wire button ÔåÆ backend ÔåÆ outputs
    ...
    # ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
    # TAB 2 ÔÇö Secure Validation Audit Portal
    # ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
    with gr.Tab("´©Å 2. Secure Validation Audit Portal"):

        gr.Markdown("""
        ### Two-Stage Secure Validation Pipeline
        **Stage 1 (deterministic):** The enterprise regex PII cleaner runs FIRST ÔÇö
        ...
        **Stage 2 (LLM):** Only the purified context reaches **gemini-1.5-pro** for
        ...
        # ÔöÇÔöÇ Input section ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        with gr.Row():
            tab2_raw_input = gr.Textbox(
                label=" Paste Log Text  [ Raw input ÔÇö paste any AV log here ]",
                lines=12,
                placeholder=(
                    ...
                    "  AV-REG-102 sensor fault active ÔÇö wet road surface observed."
                ),
        ...
        with gr.Row():
            tab2_audit_btn = gr.Button(
                "´©Å Run Safe Validation Audit",
                variant="primary",
                size="lg",
                elem_classes=["audit-btn"],
            )

        # ÔöÇÔöÇ Stage 1 output: redaction status banner ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        ...
        tab2_redaction_status = gr.Textbox(
            label=" PII Sanitisation Status  [ Stage 1 ÔÇö Regex Cleaner Audit Log ]",
            lines=10,
            interactive=False,
            elem_classes=["status-banner"],
        )

        # ÔöÇÔöÇ Stage 1 output: purified prompt context ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        # This is the BOUNDARY ÔÇö the text that crosses from the deterministic
        # security layer into the LLM layer. Labelled prominently.
        tab2_purified_context = gr.Textbox(
            label=(
                " Purified Outbound Prompt Context  "
                "[ Ô£à SECURITY CLEARED ÔÇö This text only is forwarded to gemini-1.5-pro ]"
            ),
            lines=12,
            interactive=False,
        )

        # ÔöÇÔöÇ Stage 2 output: compliance report ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
        ...
        tab2_report = gr.Markdown(
            label=" Audited Corporate Compliance Report  [ Stage 2 ÔÇö gemini-1.5-pro output ]",
            value="> Ô¼å´©Å Paste a log and click **Run Safe Validation Audit** to generate the compliance report.",
        )
        ...
        gr.Markdown("""
        *ÔÜá´©Å Note: The GPS location plotted above was redacted and hidden from the LLM model for privacy reasons. It was retrieved securely via Case ID from the raw input exclusively for this map display.*
        """)

        # Wire button ÔåÆ backend ÔåÆ all three outputs
    ...
    # ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
    # TAB 3 ÔÇö Automated Performance Evaluation Suite
    # ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
    with gr.Tab(" 3. Automated Performance Evaluation"):
        ...
        - **Suite 1** ÔÇö JSONL dataset recall tests (`tests/evaluation/datasets/pii_redaction.jsonl`)
        - **Suite 2** ÔÇö Smoke tests covering each PII category in isolation and combination
        - **Suite 3** ÔÇö Guardrail boundary tests verifying non-PII technical content is preserved
        """)
        ...
        tab3_results = gr.Textbox(
            label=" Evaluation Results  [ Pass/Fail metrics ÔÇö raw output ]",
            lines=40,
            interactive=False,
        ...
        > These tests run entirely offline ÔÇö no API calls, no model inference required.
        """)

        # Wire button ÔåÆ backend ÔåÆ results textbox
        tab3_eval_btn.click(
    ...
    # ÔöÇÔöÇ Initialise session ID when dashboard loads ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
